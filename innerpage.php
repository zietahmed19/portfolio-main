...
<head>
  ...
  <style>
    body{
      background:linear-gradient(to right,#040b14, #2c2f3f);  /* fallback for old browsers */
      background: -webkit-linear-gradient(to right,#040b14, #2c2f3f);  /* Chrome 10-25, Safari 5.1-6 */
      background: linear-gradient(to right,#040b14, #2c2f3f); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
  ...
  <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header"style="background-image:linear-gradient(to right,#040b14, #2c2f3f)">
        <h4 class="modal-title" style="color: #fff" >Insert Project</h4>
        </div>
        <div class="modal-body" style="background-color: #fff; color:#1c2638;" >
       ...
       <input type="file" name="image[]"  required  multiple accept=".jpg, .png, .jpeg" />
        ...
        <div class="modal-footer" style="background-image:linear-gradient(to right,#040b14, #2c2f3f)" >
        <button  class="btn" type="submit" name="insert" style="background-color:#040b14"><b style="color:#fff">Insert<b></button>
        </div>
        </form>
      </div>
...
<div id="edit" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header"style="background-image:linear-gradient(to right,#040b14, #2c2f3f)">
        <h4 class="modal-title"style="color:#fff">Modify Infos</h4>
      </div>
